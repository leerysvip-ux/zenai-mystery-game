...
const rawEpisodes = [
  ...
  },
  {
    ...
    cardText: "A face appears in the train window inside a tunnel.",
    intro: "You take the last train home. In the tunnel, the window becomes a mirror.",
    scene: "In the reflection, a pale face sits beside you. The seat beside you is empty.<br><br>What do you do?",
    choices: [
      ["Look at the seat", "You turn to the empty seat...", "Seat Ending", "It is empty but warm. The reflection smiles."],
      ["Stare at window", "You keep watching...", "Window Ending", "The face leans closer until it touches the glass from your side."],
      ["Move cars", "You enter the next car...", "Car Ending", "Every passenger has the same pale face turned toward you."],
      ["Get off early", "You step off...", "Station Ending", "In every train window, the face is still beside where you sat."]
    ]
  },
  {
    id: "red-umbrella",
    ...
    intro: "For three rainy nights, a red umbrella appears outside your door. It is always dry.",
    scene: "Tonight, a note on the handle says: Take it before the rain remembers you.<br><br>What do you do?",
    choices: [
      ["Take it", "You pick it up...", "Umbrella Ending", "When opened, the rain stops everywhere except directly above you."],
      ["Leave it outside", "You close the door...", "Doorstep Ending", "Water drips from your ceiling in the shape of footprints."],
      ["Read the note", "You turn the note over...", "Note Ending", "The back says: Too late. It already remembers."],
      ["Throw it away", "You toss it into trash...", "Return Ending", "The trash can fills with rainwater. The umbrella floats back up."]
    ]
  },
  {
    id: "locked-inbox",
    title: "The Locked Inbox",
    cardText: "Your inbox receives messages from yourself one year later.",
    intro: "You find a new email folder called LOCKED. The messages are from your own address.",
    scene: "The newest message is dated one year from now. Subject: Do not reply this time.<br><br>What do you do?",
    choices: [
      ["Open it", "You open the email...", "Email Ending", "It says: If you are reading this, the first loop failed."],
      ["Reply", "You type a reply...", "Reply Ending", "A new message appears: That is exactly what I did."],
      ["Delete folder", "You delete LOCKED...", "Deleted Ending", "The folder returns, now titled OPENED."],
      ["Check sent mail", "You open sent mail...", "Sent Ending", "Hundreds of warnings you never wrote are waiting there."]
    ]
  },
  {
    id: "corridor-camera",
    title: "The Corridor Camera",
    cardText: "A camera records you in a corridor you never entered.",
    intro: "Your building sends a security alert. The video shows you in a service corridor at 2:13 AM.",
    scene: "In the footage, you face the camera and mouth two words: Help me.<br><br>What do you do?",
    choices: [
      ["Find the corridor", "You search the building...", "Corridor Ending", "You find it behind Storage. The camera is already pointed at you."],
      ["Call security", "You call the desk...", "Security Ending", "The guard says the camera was removed last month, then asks why you are on it."],
      ["Replay video", "You watch again...", "Replay Ending", "This time, the video-you mouths: Behind you."],
      ["Delete alert", "You delete it...", "Alert Ending", "A new alert appears: Motion detected inside your apartment."]
    ]
  },
  {
    id: "birthday-call",
    ...
    intro: "At midnight on your birthday, an unknown number calls like it has every year since you were ten.",
    scene: "This year, the voice does not say happy birthday. It counts backward from ten.<br><br>What do you do?",
    choices: [
      ["Listen", "You stay silent...", "Countdown Ending", "At zero, someone knocks on your door exactly once."],
      ["Hang up", "You end the call...", "Hang Up Ending", "The phone rings again from inside your closed drawer."],
      ["Ask who it is", "You interrupt...", "Caller Ending", "The voice says your name, then adds: Not yet, but soon."],
      ["Block number", "You block it...", "Blocked Ending", "Your screen shows one blocked contact: Future You."]
    ]
  },
  {
    id: "letters-from-her",
    title: "Letters From Her",
    cardText: "The Red Eye shows letters from someone you forgot you loved.",
    intro: "The red eye icon opens by itself. Inside are letters signed only with one initial.",
    scene: "The first letter says: If you are reading this, the fear worked. Now you are ready for the truth.<br><br>What do you do?",
    choices: [
      ["Read the first letter", "You open it carefully...", "Letter Ending", "She writes that every strange room was built from a memory you refused to face."],
      ["Search the initial", "You search old contacts...", "Initial Ending", "One deleted contact returns: the person who saved you once and disappeared."],
      ["Close the app", "You close the Red Eye...", "Closed Ending", "A notification appears: I waited until you were strong enough."],
      ["Ask who she was", "You type the question...", "Truth Ending", "The app answers: The one you promised you would never forget."]
    ]
  },
  {
    id: "the-night-of-the-accident",
    title: "The Night of the Accident",
    cardText: "The final files begin showing the night everything changed.",
    intro: "The Red Eye replays a rainy road, broken glass, and a hand pushing you away from danger.",
    scene: "You finally remember there was someone beside you that night. Someone who did not get out.<br><br>What do you do?",
    choices: [
      ["Reach for the memory", "You reach into the replay...", "Memory Ending", "You feel her hand again, letting go only after making sure you were safe."],
      ["Look away", "You turn from the scene...", "Avoid Ending", "The rain follows you into every room until you stop running."],
      ["Say her name", "You whisper the name...", "Name Ending", "The Red Eye turns warm for the first time."],
      ["Ask why she stayed", "You ask the file...", "Answer Ending", "A recording plays: Because you still had a life to live."]
    ]
  },
  {
    id: "the-room-of-goodbyes",
    title: "The Room of Goodbyes",
    cardText: "A room opens with every goodbye you never said.",
    intro: "One final door appears. Behind it are chairs, letters, and empty places saved for people you lost.",
    scene: "At the center is a chair with her coat on it. The Red Eye says: Sit only if you are ready to listen.<br><br>What do you do?",
    choices: [
      ["Sit down", "You sit in the chair...", "Listening Ending", "Her voice fills the room, not blaming you, only asking you to stop punishing yourself."],
      ["Pick up the coat", "You hold the coat...", "Coat Ending", "It still smells like rain and the hospital hallway where you said nothing."],
      ["Read every letter", "You open the letters...", "Letters Ending", "Every letter ends the same way: I forgive you before you ask."],
      ["Leave the room", "You step back...", "Unready Ending", "The door remains open behind you, waiting without anger."]
    ]
  },
  {
    id: "final-goodbye",
    title: "Final Goodbye",
    cardText: "The Red Eye offers one last choice: stay in the loop, or leave with the truth.",
    intro: "All fifty files unlock. The Red Eye is no longer red. It looks like a sunrise through rain.",
    scene: "She stands at the end of the hallway, smiling like she has waited years to say one sentence. She says: I did not come back to keep you here. I came back to help you leave.<br><br>What do you do?",
    choices: [
      ["Stay with her", "You step toward her...", "Stay Ending", "For one perfect moment, the world stops hurting. But the hallway begins closing, and she cries because she knows you chose pain over life."],
      ["Leave and remember", "You step back with tears in your eyes...", "True Goodbye Ending", "She smiles through the rain. The Red Eye closes. You wake up remembering her, and finally breathing."],
      ["Ask for one more minute", "You ask for just one more minute...", "One More Minute Ending", "She gives you sixty seconds. You spend all of them saying thank you."],
      ["Promise to live", "You make the promise she waited to hear...", "Promise Ending", "The final file unlocks: She was never trying to trap you in the loop. She was trying to help you leave it."]
    ]
  }
];

window.games = rawEpisodes.map((episode) => ({
  ...episode,
